...
As configurações do GIT são armazenadas no arquivo **.gitconfig** localizado dentro do diretório do usuário do Sistema Operacional (Ex.: Windows: C:\Users\Documents and Settings\Fernando ou *nix /home/Fernando).
...
##### Setar email
	git config --global user.email fernando@gmail.com
